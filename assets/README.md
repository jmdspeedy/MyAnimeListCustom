...
This directory is served by GitHub Pages and contains only optimized,
...
Do not overwrite a published filename with unrelated content. Increment the
version suffix when an asset changes.
